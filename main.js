...
search.addEventListener('change',(e)=>{
  keyword = e.target.value; // or search.value
},false)

submit.addEventListener('click',()=>{ search.value && searchData() },false)
...
vegetables.addEventListener('click', filterData, false);
flowers.addEventListener('click', filterData, false);
fruits.addEventListener('click', filterData, false);
...
sort.addEventListener('click', sortData, false);
